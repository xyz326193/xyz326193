          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 shadow-sm hover:shadow-lg transition-shadow duration-300">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Sarah Johnson</h2>
                <p className="text-gray-600 dark:text-gray-300">Creative Parent</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Member since {userStats.accountCreated}</p>
              </div>

              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-coral-50 dark:bg-coral-900/20 rounded-lg">
                  <div className="flex items-center space-x-2">
                    <Palette className="w-5 h-5 text-coral-500" />
                    <span className="text-coral-700 dark:text-coral-300 font-medium">Generated</span>
                  </div>
                  <span className="text-coral-600 dark:text-coral-400 font-semibold">{userStats.totalGenerated}</span>
                </div>

                <div className="flex items-center justify-between p-3 bg-mint-50 dark:bg-mint-900/20 rounded-lg">
                  <div className="flex items-center space-x-2">
                    <Download className="w-5 h-5 text-mint-500" />
                    <span className="text-mint-700 dark:text-mint-300 font-medium">Downloads</span>
                  </div>
                  <span className="text-mint-600 dark:text-mint-400 font-semibold">{userStats.totalDownloads}</span>
                </div>

                <div className="flex items-center justify-between p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                  <div className="flex items-center space-x-2">
                    <Heart className="w-5 h-5 text-purple-500" />
                    <span className="text-purple-700 dark:text-purple-300 font-medium">Favorites</span>
                  </div>
                  <span className="text-purple-600 dark:text-purple-400 font-semibold">{userStats.favoriteTemplates}</span>
                </div>
              </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button className="flex items-center space-x-3 p-4 bg-coral-50 dark:bg-coral-900/20 rounded-lg hover:bg-coral-100 dark:hover:bg-coral-900/30 transition-colors duration-200">
                  <Palette className="w-6 h-6 text-coral-500" />
                  <div className="text-left">
                    <p className="font-medium text-coral-700 dark:text-coral-300">Create New Page</p>
                    <p className="text-sm text-coral-600 dark:text-coral-400">Start a new coloring project</p>
                  </div>
                </button>

                <button className="flex items-center space-x-3 p-4 bg-mint-50 dark:bg-mint-900/20 rounded-lg hover:bg-mint-100 dark:hover:bg-mint-900/30 transition-colors duration-200">
                  <History className="w-6 h-6 text-mint-500" />
                  <div className="text-left">
                    <p className="font-medium text-mint-700 dark:text-mint-300">View History</p>
                    <p className="text-sm text-mint-600 dark:text-mint-400">Browse your creations</p>
                  </div>
                </button>
                ...
                <button className="flex items-center space-x-3 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors duration-200">
                  ...
                  <div className="text-left">
                    <p className="font-medium text-purple-700 dark:text-purple-300">Favorites</p>
                    <p className="text-sm text-purple-600 dark:text-purple-400">View saved templates</p>
                  </div>
                </button>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">Keep track of your generated images</p>
                  </div>
                  <input type="checkbox" className="w-5 h-5 text-coral-500" defaultChecked />
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900 dark:text-white">High Quality Downloads</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Always download in highest resolution</p>
                  </div>
                  <input type="checkbox" className="w-5 h-5 text-coral-500" defaultChecked />
                </div>
              </div>
